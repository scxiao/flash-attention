...
configs = [
            (2, 16384, 16384, 32, 32, 64, False, (2048, 0)),
            (2, 16384, 16384, 32, 32, 64, True,  (2048, 0)),
            (2, 16384, 16384, 32,  4, 64, False, (2048, 0)),
            (2, 16384, 16384, 32,  4, 64, True,  (2048, 0)),
            (4,  4096,  4096, 48,  6, 64, True,  (2047, 0)),
            (4,  4096, 16384, 48,  6, 64, True,  (2047, 0)),
            # Same configs with full window size
            (2, 16384, 16384, 32, 32, 64, False, (-1, -1)),
            (2, 16384, 16384, 32, 32, 64, True,  (-1, -1)),
            (2, 16384, 16384, 32,  4, 64, False, (-1, -1)),
            (2, 16384, 16384, 32,  4, 64, True,  (-1, -1)),
...
def print_summary_table(all_results):
    ...
    for item in all_results:
        ...
        r = results['nondet']
        print(f"{config_str:<55} | {'det=False':<20} | {r['fwd_time']*1e3:<10.3f} | "
              f"{r['bwd_time']*1e3:<10.3f} | {r['fwd_tflops']:<10.2f} | {r['bwd_tflops']:<10.2f}")

        r = results['det']
        print(f"{config_str:<55} | {'det=True':<20} | {r['fwd_time']*1e3:<10.3f} | "
              f"{r['bwd_time']*1e3:<10.3f} | {r['fwd_tflops']:<10.2f} | {r['bwd_tflops']:<10.2f}")
